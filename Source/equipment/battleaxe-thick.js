...
module.exports = new EquipmentTemplate("Thick Battleaxe", "Strike a foe for @{damage} @{element} damage, but gain @{mod1Stacks} @{mod1}", "Damage x@{critBonus}", "Fire", effect, ["Prideful Battleaxe", "Thirsting Battleaxe"])
	.setCategory("Weapon")
