...
module.exports = new EquipmentTemplate("Tormenting Sun Flare", "Inflict @{mod1Stacks} @{mod1} and duplicate its debuffs with priority", "Also inflict @{mod2Stacks} @{mod2}", "Wind", needsLivingTargets(effect))
	.setCategory("Spell")
