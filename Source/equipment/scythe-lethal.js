...
module.exports = new Equipment("Lethal Scythe", 2, "*Strike a foe for @{damage} @{element} damage; instant death if foe is at or below @{bonusDamage} hp*\nCritical Hit: Instant death threshold x@{critBonus}", "Darkness", effect, ["Piercing Scythe", "Toxic Scythe"])
	.setCategory("Weapon")
