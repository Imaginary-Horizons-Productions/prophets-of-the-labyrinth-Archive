...
module.exports = new EquipmentTemplate("Double Pistol", "Strike a foe for @{damage} @{element} damage, give 2 random allies @{mod1Stacks} @{mod1} if the foe is weak to @{element}", "Damage x@{critBonus}", "Earth", effect)
	.setCategory("Weapon")
