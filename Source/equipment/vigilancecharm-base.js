...
module.exports = new EquipmentTemplate("Vigilance Charm", "Gain @{mod1Stacks} @{mod1}", "@{mod1} +@{bonus}", "Earth", effect, ["Long Vigilance Charm", "Devoted Vigilance Charm", "Guarding Vigilance Charm"])
	.setCategory("Trinket")
