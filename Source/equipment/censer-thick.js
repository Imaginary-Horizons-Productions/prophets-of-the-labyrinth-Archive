...
module.exports = new EquipmentTemplate("Thick Censer", "Burn a foe for @{damage} (+@{bonus} if target has any debuffs) @{element} damage", "Also apply @{mod1Stacks} @{mod1}", "Fire", needsLivingTargets(effect))
	.setCategory("Trinket")
