...
module.exports = new EquipmentTemplate("Slowing War Cry", "Inflict @{mod1Stacks} @{mod1} and @{mod2Stacks} @{mod2} on a foe and all foes with Exposed", "@{mod1} +@{bonus}", "Fire", effect)
	.setCategory("Spell")
