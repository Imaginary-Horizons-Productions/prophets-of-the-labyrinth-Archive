...
module.exports = new EquipmentTemplate("Piercing Scythe", "Strike a foe for @{damage} @{element} unblockable damage; instant death if foe is at or below @{bonus} hp", "Instant death threshold x@{critBonus}", "Wind", needsLivingTargets(effect))
	.setCategory("Weapon")
