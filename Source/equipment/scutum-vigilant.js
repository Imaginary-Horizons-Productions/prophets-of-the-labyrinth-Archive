...
module.exports = new EquipmentTemplate("Vigilant Scutum", "Grant @{block} block to an ally and yourself and gain @{mod1Stacks} @{mod1}", "Block x@{critBonus}", "Fire", effect, ["Heavy Scutum", "Sweeping Scutum"])
	.setCategory("Armor")
