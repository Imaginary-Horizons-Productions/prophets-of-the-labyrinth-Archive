...
module.exports = new EquipmentTemplate("Iron Fist Stance", "Increase Punch damage by @{bonus} and stagger by @{critBonus} (exit other stances)", "Gain @{mod2Stacks} @{mod2}", "Wind", effect)
