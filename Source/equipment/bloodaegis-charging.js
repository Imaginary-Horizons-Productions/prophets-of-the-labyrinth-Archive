...
module.exports = new EquipmentTemplate("Charging Blood Aegis", "Pay @{hpCost} hp; gain @{block} block, @{mod1Stacks} @{mod1}, intercept a later single target move", "Block x@{critBonus}", "Water", effect)
	.setCategory("Pact")
