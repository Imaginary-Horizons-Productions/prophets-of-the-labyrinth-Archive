...
module.exports = new EquipmentTemplate("Slowing Daggers", "Strike a foe for @{damage} @{element} damage and inflict @{mod1Stacks} @{mod1}", "Damage x@{critBonus}", "Wind", effect)
	.setCategory("Weapon")
