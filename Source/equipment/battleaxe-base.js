...
module.exports = new EquipmentTemplate("Battleaxe", "Strike a foe for @{damage} @{element} damage, but gain @{mod1Stacks} @{mod1}", "Damage x@{critBonus}", "Fire", effect, ["Thick Battleaxe", "Thirsting Battleaxe"])
	.setCategory("Weapon")
