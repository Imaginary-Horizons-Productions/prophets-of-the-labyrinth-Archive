...
module.exports = new EquipmentTemplate("Battleaxe", "Strike a foe for @{damage} @{element} damage, gain @{mod1Stacks} @{mod1}", "Damage x@{critBonus}", "Fire", effect, ["Prideful Battleaxe", "Thick Battleaxe", "Thirsting Battleaxe"])
	.setCategory("Weapon")
