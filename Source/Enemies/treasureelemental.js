...
module.exports = new Enemy("Treasure Elemental")
	...
	.addAction({ name: "Guarding Slam", element: "Earth", priority: 0, effect: guardingSlamEffect, selector: selectRandomFoe, next: treasureElementalPattern })
	.addAction({ name: "Burrow", element: "Untyped", priority: 0, effect: burrowEffect, selector: selectSelf, next: treasureElementalPattern })
	.addAction({ name: "Eyes of Greed", element: "Untyped", priority: 0, effect: eyesOfGreedEffect, selector: selectAllFoes, next: treasureElementalPattern })
	.addAction({ name: "Heavy Pockets", element: "Untyped", priority: 0, effect: heavyPocketsEffect, selector: selectAllFoes, next: treasureElementalPattern })
	.addAction({ name: "Escape", element: "Untyped", priority: 0, effect: escapeEffect, selector: selectNone, next: treasureElementalPattern })
