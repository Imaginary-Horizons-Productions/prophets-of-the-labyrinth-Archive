...
module.exports = new Enemy("Treasure Elemental")
	...
	.addAction({ name: "Guarding Slam", isPriority: false, effect: guardingSlamEffect, selector: selectRandomFoe, next: treasureElementalPattern })
	.addAction({ name: "Evade", isPriority: false, effect: evadeEffect, selector: selectSelf, next: treasureElementalPattern })
	.addAction({ name: "Eyes of Greed", isPriority: false, effect: eyesOfGreedEffect, selector: selectAllFoes, next: treasureElementalPattern })
	.addAction({ name: "Heavy Pockets", isPriority: false, effect: heavyPocketsEffect, selector: selectAllFoes, next: treasureElementalPattern })
	.addAction({ name: "Escape", isPriority: false, effect: escapeEffect, selector: selectNone, next: treasureElementalPattern })
