...
module.exports = new Weapon("Earthen Potion", 2, "*Apply @{mod1Stacks} @{mod1} to a Earth element combatant, or @{mod2Stacks} @{mod2} to someone else*\nCritical Hit: @{mod1}/@{mod2} x@{critMultiplier}", "Earth", effect, ["Inky Potion", "Watery Potion"])
