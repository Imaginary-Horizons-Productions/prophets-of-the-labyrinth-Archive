...
module.exports = new Weapon("Inky Potion", "*Apply 4 Regen to a Darkness element combatant, or 4 Poison to someone else*\nCritical Hit: Poison/Regen x@{critMultiplier}", "Darkness", effect, [])
