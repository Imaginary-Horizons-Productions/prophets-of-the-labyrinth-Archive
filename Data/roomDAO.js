...
exports.decrementForgeSupplies = function (interaction, roomMessageId, adventure) {
	...
	return interaction.channel.messages.fetch(roomMessageId).then(roomMessage => {
		...
		roomEmbed.spliceFields(roomEmbed.fields.findIndex(field => field.name === "Remaining Forge Supplies"), 1, { name: "Remaining Forge Supplies", value: adventure.room.resources.forgeSupplies.count.toString() })
